...
<optgroup label="America">
    ...
    <option value="America/Argentina/ComodRivadavia">ComodRivadavia</option>
    ...
    <option value="America/Indiana/Knox">Knox</option>
    <option value="America/Indiana/Marengo">Marengo</option>
    <option value="America/Indiana/Petersburg">Petersburg</option>
    <option value="America/Indiana/Tell_City">Tell City</option>
    <option value="America/Indiana/Vevay">Vevay</option>
    <option value="America/Indiana/Vincennes">Vincennes</option>
    <option value="America/Indiana/Winamac">Winamac</option>
    ...
    <option value="America/Kentucky/Louisville">Louisville</option>
    <option value="America/Kentucky/Monticello">Monticello</option>
    ...
    <option value="America/North_Dakota/Beulah">Beulah</option>
    <option value="America/North_Dakota/Center">Center</option>
    <option value="America/North_Dakota/New_Salem">New_Salem</option>
...
<optgroup label="Asia">
    ...
    <option value="Asia/Ho_Chi_Minh">Ho Chi_Minh</option>
...
<optgroup label="Other">
    <option value="Other/GB">GB</option>
    <option value="Other/GB-Eire">GB-Eire</option>
    <option value="Other/Greenwich">Greenwich</option>
    <option value="Other/Hongkong">Hongkong</option>
    <option value="Other/HST">HST</option>
    <option value="Other/Iceland">Iceland</option>
    <option value="Other/Iran">Iran</option>
    <option value="Other/Israel">Israel</option>
    <option value="Other/Jamaica">Jamaica</option>
    <option value="Other/Japan">Japan</option>
    <option value="Other/Kwajalein">Kwajalein</option>
    <option value="Other/Libya">Libya</option>
    <option value="Other/MET">MET</option>
    <option value="Other/MST">MST</option>
    <option value="Other/MST7MDT">MST7MDT</option>
    <option value="Other/Navajo">Navajo</option>
    <option value="Other/NZ">NZ</option>
    <option value="Other/NZ-CHAT">NZ-CHAT</option>
    <option value="Other/Poland">Poland</option>
    <option value="Other/Portugal">Portugal</option>
    <option value="Other/PRC">PRC</option>
    <option value="Other/PST8PDT">PST8PDT</option>
    <option value="Other/ROC">ROC</option>
    <option value="Other/ROK">ROK</option>
    <option value="Other/SECURITY">SECURITY</option>
    <option value="Other/Singapore">Singapore</option>
    <option value="Other/Turkey">Turkey</option>
    <option value="Other/Universal">Universal</option>
    <option value="Other/W-SU">W-SU</option>
    <option value="Other/WET">WET</option>
    <option value="Other/Zulu">Zulu</option>
    <option value="Other/Cuba">Cuba</option>
    <option value="Other/Egypt">Egypt</option>
</optgroup>
